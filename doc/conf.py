...
latex_documents = [
    (master_doc, 'Certhub.tex', 'Certhub Documentation',
...
man_pages = [
    ...
    ('certhub-systemd.unit.5', 'certhub-systemd.unit', 'Certhub Documentation', [author], 5),
    ...
    ('certhub-lego-run@.service.8', 'certhub-lego-run@.service', 'Certhub Documentation', [author], 8),
    ...
    ('certhub-hook-nsupdate-auth.8', 'certhub-hook-nsupdate-auth', 'Certhub Documentation', [author], 8),
]
...
texinfo_documents = [
    (master_doc, 'Certhub', 'Certhub Documentation',
     author, 'Certhub', 'One line description of project.',
     'Miscellaneous'),
]
